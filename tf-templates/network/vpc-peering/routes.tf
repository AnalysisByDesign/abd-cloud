...
resource "aws_route" "requester_public" {
  ...
  destination_cidr_block = "${var.accepter_cidr_override != "" 
                                          ? var.accepter_cidr_override 
...
resource "aws_route" "accepter_public" {
  ...
  destination_cidr_block = "${var.requester_cidr_override != "" 
                                          ? var.requester_cidr_override 
                                          : local.vpc_cidr}"
